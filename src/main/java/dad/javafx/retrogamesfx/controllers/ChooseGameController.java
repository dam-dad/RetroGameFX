...
import dad.javafx.retrogamesfx.games.brickbreaker.BrickBreaker;
import dad.javafx.retrogamesfx.games.labyrinth.Labyrinth;
import dad.javafx.retrogamesfx.games.pong.Pong;
import dad.javafx.retrogamesfx.games.snake.SnakeGame;
...
public class ChooseGameController implements Initializable {
	...
	void onComprar1Action(ActionEvent event) {
		if (!comprar1) {
			...
			comprar1 = true;
			Pong.setStyle(
					"-fx-background-image:url(./images/Pong.PNG);-fx-background-size:200px,200px;-fx-background-size:cover,contain;");
	...
	void onComprar2Action(ActionEvent event) {
		if (!comprar2) {
			...
			comprar2 = true;
			Brick.setStyle(
					"-fx-background-image:url(./images/BrickBreaker.PNG);-fx-background-size:200px,200px;-fx-background-size:cover,contain;");
		}
	}
	...
	void onComprar3Action(ActionEvent event) {
		if (!comprar3) {
			...
			comprar3 = true;
			Snake.setStyle(
					"-fx-background-image:url(./images/Snake.PNG);-fx-background-size:200px,200px;-fx-background-size:cover,contain;");
		}
	}
	...
	void onComprar4Action(ActionEvent event) {
		if (!comprar4) {
			...
			comprar4 = true;
			Lab.setStyle(
					"-fx-background-image:url(./images/Laberinto.PNG);-fx-background-size:200px,200px;-fx-background-size:cover,contain;");
		}
	}
